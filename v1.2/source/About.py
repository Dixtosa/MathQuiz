...
class ABOUT_PROGRAMMERS(wx.Frame):
	def __init__(self):
		...
		for i in range(1080/l):
			...
			LP.SetFont(wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.ITALIC, wx.NORMAL))
			
			LP_D=wx.StaticText(panel,-1," Dixtosa",pos=(250,525-(j-l)))
			LP_D.SetForegroundColour(panel_color)
			LP_D.SetFont(wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.NORMAL, wx.NORMAL))
			
			HP=wx.StaticText(panel,-1,"Helper Programmer:",pos=(250,600-(j-l)))
			HP.SetForegroundColour(panel_color)
			HP.SetFont(wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.ITALIC, wx.NORMAL))
			
			HP_DN=wx.StaticText(panel,-1," Doesn't Need;)",pos=(250,625-(j-l)))
			HP_DN.SetForegroundColour(panel_color)
			HP_DN.SetFont(wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.NORMAL, wx.NORMAL))
			
			L=wx.StaticText(panel,-1,"Dixtosa © 2009",pos=(270,1100-(j-l)))
			L.SetForegroundColour(panel_color)
			L.SetFont(wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.NORMAL, wx.NORMAL))
			
			
			wx.StaticText(panel,-1,"Lead Programmer:",pos=(250,500-j))\
				.SetFont(wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.ITALIC, wx.NORMAL))
			wx.StaticText(panel,-1," Dixtosa",pos=(250,525-j))\
				.SetFont(wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.NORMAL, wx.NORMAL))
			wx.StaticText(panel,-1,"Helper Programmer:",pos=(250,600-j))\
				.SetFont(wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.ITALIC, wx.NORMAL))
			wx.StaticText(panel,-1," Doesn't Need;)",pos=(250,625-j))\
				.SetFont(wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.NORMAL, wx.NORMAL))
			wx.StaticText(panel,-1,"Dixtosa © 2009",pos=(270,1100-j))\
				.SetFont(wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.NORMAL, wx.NORMAL))
			if i==(1080/l-1):
				time.sleep(2)
				self.Close()
